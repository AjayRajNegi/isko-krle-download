    ...
    <div class="header">
      ...
      <div class="navbar">
        ...
        <div class="right-nav">
          ...
          <div class="all"><a href="profile.php"><?php echo $_SESSION['username']?></a></div>
          <div class="all"><a href="logout.php">LOGOUT</a></div>
        </div>
        <div class="hamburger">
          <div class="line"></div>
          <div class="line"></div>
      ...
      <div class="resp-nav">
        <ul class="menu">
          ...
          <li class="item" style="background: black"><a href="#about">ABOUT</a></li>
          <li class="item" style="background: black"><a href="#lawyers">LAWYERS</a></li>
          <li class="item" style="background: black">
            <a href="#testimonials">TESTIMONIALS</a>
          </li>
          <li class="item" style="background: black"><a href="#contact">CONTACT</a></li>
          <li class="item" style="background: black"><a href="profile.php"><?php echo $_SESSION['username']?></a></li>
          <li class="item" style="background: black">
